      ...
      <div className="relative w-full max-w-sm animate-slide-up">
        ...
        <div className="card p-6">
          ...
          <div className="flex flex-col gap-2.5 mb-5">
            ...
            <button disabled
              className="flex items-center justify-center gap-3 rounded-xl border border-white/5 bg-white/[0.02] px-4 py-2.5 text-sm font-medium text-ink-faint cursor-not-allowed opacity-50">
              <AppleIcon />
              Continue with Apple
              <span className="ml-auto text-[10px] rounded-full border border-white/10 px-2 py-0.5">Soon</span>
            </button>
          </div>
